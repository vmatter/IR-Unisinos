...
namespace SearchStringHandler
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            string searchStringCleaned = Utils.CleanSearchString(searchString);

            // TODO: Pedir para o Marcio se tem como voltar ao início do programa estando dentro da classe.
            try
            {
                areValidParentheses = Utils.ValidateStringConditions(searchStringCleaned);
            }
            ...
            Stack<string> searchStringTokens = Utils.TokenizeSearchString(searchStringCleaned, areValidParentheses);
            ...
            Utils.SearchTokensInPDF(filePath, searchStringCleaned, ++contQuery);
